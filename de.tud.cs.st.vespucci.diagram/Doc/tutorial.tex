...
\item  Die Anmeldenamen an Ralf Mitschke (mitschke@st.informatik.tu-darmstadt.de) schicken, damit er das Projekt für diese freigeben kann
...
\item[VespucciTransformationHelper.java] Das ist eine Template-Klasse, die die Methoden zur
Tranformation in Vespucci unterstützt
...
\begin{itemize}
\item Die gmfgen-Datei muss neu erstellt werden, sobald Veränderungen in ecore, gmfgraph, gmftool oder gmfmap stattgefunden haben.
\item Um eine neue gmfgen-Datei zu erzeugen, mache einen Rechtsklick auf die gmfmap-Datei $\rightarrow$ wähle dann ''Create generator model...''
...
\item[alle Branches anzeigen lassen] \textcolor{blue}{git branch -a}
...
\item[in einen Branch mergen] Im Zielordner \textcolor{blue}{git merge branchname} ausführen (dabei ist ''branchname'' der Ordner, der hinzugefügt werden soll)
