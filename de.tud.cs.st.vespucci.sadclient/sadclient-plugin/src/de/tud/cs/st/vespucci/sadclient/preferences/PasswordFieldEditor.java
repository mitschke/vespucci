 ...
 * <p>
 * Since the StringFieldEditor can't be extended properly to just change the
 * style, and the style cannot be changed after instantiation, there seems
 * to be no other solution than to copy nearly the entire StringFieldEditor.
 * <p>
 * 
 * @author Mateusz Parzonka (adapted from StringFieldEditor)
 * 
 *         </p>
 */
public class PasswordFieldEditor extends StringFieldEditor {
     ...
     * <p>
     * The password field implementation of this <code>FieldEditor</code>
	...
	if (textField == null) {
	    // Since the StringFieldEditor can't be extended properly to just
	    // change the style, and the style cannot be changed after
	    // instantiation, there seems to be no other solution than to copy
	    // nearly the entire StringFieldEditor.
