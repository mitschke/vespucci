package de.tud.cs.st.vespucci.view.currentdiagrams;
...
import de.tud.cs.st.vespucci.view.currentdiagrams.model.Pair;
import de.tud.cs.st.vespucci.view.currentdiagrams.views.CurrentDiagramsView;
	...
	public void processResult(Object result, IFile diagramFile) {
		...
		if (violationView != null){
			...
			try {
				...
				CurrentDiagramsView.addElement(element);
